...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbers.add(new Numbers("one","một"));
        numbers.add(new Numbers("two","hai"));
        numbers.add(new Numbers("three","ba"));
        numbers.add(new Numbers("four","bốn"));
        numbers.add(new Numbers("five","năm"));
        numbers.add(new Numbers("six","sáu"));
        numbers.add(new Numbers("seven","bảy"));
        numbers.add(new Numbers("eight","tám"));
        numbers.add(new Numbers("night","chín"));
        numbers.add(new Numbers("ten","mười"));
       ...
       /* // Create for loop to create text view for each numbers
        ...
        NumbersAdapter itemsAdapter = new NumbersAdapter(this,numbers,R.color.category_phrases);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED){
                    ...
                    mWordAudio= MediaPlayer.create(PhrasesActivity.this,number.getmSong());
                    mWordAudio.start();
